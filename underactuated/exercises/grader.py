...
class Grader:
    ...
    def grade_from_dills(notebook_dill_list, test_cases_list, results_json, notebook_ipynb_list=None):
        ...
        try:
            ...
            for notebook_dill in zip(notebook_dill_list):
            ...
            if notebook_ipynb_list:
                notebook_list = []
                for notebook_dill in zip(notebook_dill_list, test_cases_list):
                    with open(notebook_dill, "rb") as notebook_file:
                        notebook_list.append(json.load(notebook_file))

        except Exception as e:
            Grader.global_fail_with_error_message("A file is missing: " + str(e), results_json)
        raise
