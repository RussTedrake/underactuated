...
def setup_underactuated():
    ...
    try:
        ...
        if platform.system() is 'Darwin':
            get_ipython().system(u'if [ ! -d "/content/underactuated" ]; then git clone https://github.com/RussTedrake/underactuated.git && underactuated/scripts/setup/mac/install_prereqs; fi')
        else:
            get_ipython().system(u'if [ ! -d "/content/underactuated" ]; then git clone https://github.com/RussTedrake/underactuated.git && underactuated/scripts/setup/ubuntu/16.04/install_prereqs; fi')
        sys.path.append("/content/underactuated/src")
